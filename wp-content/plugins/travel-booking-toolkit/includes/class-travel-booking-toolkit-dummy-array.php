...
class Travel_Booking_Toolkit_Dummy_Array {
    ...
    */
    public function default_activities(){
        return apply_filters( 'travel_booking_toolkit_default_activities', array(
                array(
    ...
    */
    public function default_why_us(){
        return apply_filters( 'travel_booking_toolkit_default_why_us', array(
                array(
    ...
    */
    public function default_stat_counter(){
        return apply_filters( 'travel_booking_toolkit_default_stat_counter', array(
                array(
                    'icon'   => 'fa fa-group',
	...
	public function travel_booking_toolkit_default_trip_popular_packages( ) {
		$arr = apply_filters( 'travel_booking_toolkit_default_popular_packages', array(
                array(
	...
	public function travel_booking_toolkit_default_trip_featured_posts() {		
		...
		$arr = apply_filters( 'travel_booking_toolkit_default_featured_post', array(
    			array(
                    'img'            => TBT_FILE_URL.'/includes/images/popular-packages-img1.jpg',
                ...
                array(
                    ...
                    'discount'       => __( '12% Off', 'travel-booking-toolkit' ),
                    'featured'       => false,
                ...
                array(
                    ...
                    'discount'       => __( '50% Off', 'travel-booking-toolkit' ),
                    'featured'       => true,
                    'old_price'      => __( '$ 1200', 'travel-booking-toolkit' ),
                    'new_price'      => __( '$ 900', 'travel-booking-toolkit' ),
                    'group_discount' => true,
	...
	public function travel_booking_toolkit_default_trip_deal_posts() {
		...
		return apply_filters( 'travel_booking_toolkit_default_deal_post', array(
    			array(
                    'img'            => TBT_FILE_URL.'/includes/images/popular-packages-img1.jpg',
                    'discount'       => __( '45% Off', 'travel-booking-toolkit' ),
                    'featured'       => true,
    ...
    public function travel_booking_toolkit_default_destination() {
        ...
        return apply_filters( 'travel_booking_toolkit_default_destination', array(
                array(
