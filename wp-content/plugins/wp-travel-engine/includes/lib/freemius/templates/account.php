...
if ( is_object( $update ) ) {
	...
	<script type="text/javascript">
		(function ($) {
			...
			$('.fs-toggle-visibility').on( 'click', function () {
				var
					$this = $(this),
			...
			$('.fs-toggle-tracking').on('click', function () {
				setLoading(
					$(this),
			...
			$( '.fs-toggle-beta-mode' ).on( 'click', function () {
				var $checkbox = $( this ),
			...
			$deactivateLicenseOrCancelTrial.on('click', function() {
				var $this = $( this );
			...
			$('.fs-show-install-details').on('click', function(){
			...
			$sitesSection.find('.fs-search').on('keyup', function(){
			...
			$( '.fs-toggle-whitelabel-mode' ).on('click', function () {
				var $toggleLink = $( this );
