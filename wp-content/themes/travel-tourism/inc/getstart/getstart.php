...
function travel_tourism_admin_theme_style() {
   ...
   wp_enqueue_style('travel-tourism-custom-admin-style', get_template_directory_uri() . '/inc/getstart/getstart.css');
   wp_enqueue_script('travel-tourism-tabs', get_template_directory_uri() . '/inc/getstart/js/tab.js');
}
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="travel_tourism_open_tab(event, 'travel_tourism_lite')"><?php esc_html_e( 'Getting Started', 'travel-tourism' ); ?></button>		  
		...
		<!-- Tab content -->
		<div id="travel_tourism_lite" class="tabcontent open">
